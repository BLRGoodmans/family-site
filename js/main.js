...
function buildNav(root = '') {
  ...
  nav.className = 'nav';
  nav.innerHTML = `
    <a href="${root}index.html" class="nav-brand">🌳 <span>Goodman</span> Family</a>
    ...
    <ul class="nav-links" id="navLinks">
      ...
      <li class="dropdown">
        ...
        <div class="dropdown-menu">
          ...
          <a href="${root}generation-3/jessie.html">Jessie Goodman</a>
          <a href="${root}generation-3/phyllis.html">Phyllis Goodman</a>
          <a href="${root}generation-3/beryl.html">Beryl Goodman</a>
          <a href="${root}generation-3/james.html">James Goodman</a>
          <a href="${root}generation-3/robert.html">Robert Goodman</a>
          <a href="${root}generation-3/iris.html">Iris Goodman</a>
          <a href="${root}generation-3/eardley.html">Eardley Goodman</a>
          <a href="${root}generation-3/hazel.html">Hazel Goodman</a>
          <a href="${root}generation-3/jessie.html">Jessie Goodman</a>
...
function buildFooter(root = '') {
  ...
  footer.innerHTML = `
    <div class="footer-brand">🌳 Goodman Family Heritage</div>
    <p style="font-size:0.875rem;margin:0 auto;max-width:400px;">
      Four generations of Goodmans — from James &amp; Mary Blanche in 1860s India, to the great grandchildren of today.
    </p>
